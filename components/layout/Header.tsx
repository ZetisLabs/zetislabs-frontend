      ...
      <div className="relative mx-auto flex w-full max-w-screen-xl flex-nowrap items-center justify-center px-4 lg:w-5xl">
        ...
        <div className="flex w-auto items-center justify-center gap-6 rounded-md bg-background/75 px-6 py-0 backdrop-blur-md border-[0.75px] border-border/50 shadow-sm">
          ...
          <nav className="flex items-center gap-4 text-xs text-foreground">
            <Link
              href={`/${locale}`}
              className="nav-link group relative mx-1 rounded-full px-3 py-0.5 transition-colors hover:text-accent"
        ...
        <div className="absolute flex h-auto w-auto items-center justify-center gap-6 px-6 py-0 pointer-events-none">
          ...
          <div className="flex items-center gap-4 text-xs h-[40px]">
            {/* Home button shadow */}
            <div className="nav-link-home-shadow px-3 mx-1 h-full text-transparent bg-tansparent shadow-xl shadow-accent/50 opacity-0 transition-opacity duration-200 pointer-events-none z-[-1]">
              {t("header.home")}
            </div>
            {/* Blog button shadow */}
            <div className="nav-link-blog-shadow px-3 mx-1 h-full text-transparent bg-tansparent shadow-xl shadow-accent/50 opacity-0 transition-opacity duration-200 pointer-events-none z-[-1]">
              {t("header.blog")}
            </div>
          </div>
        </div>
